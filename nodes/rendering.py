    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.Vae.Input("vae"),
                io.Float.Input("omega_video", default=1.25, min=0.0, max=20.0, step=0.05, advanced=True),
                io.Float.Input("omega_image", default=3.0, min=0.0, max=20.0, step=0.05, advanced=True),
                io.Float.Input("omega_text", default=4.0, min=0.0, max=20.0, step=0.05, advanced=True),
                io.Float.Input("omega_target", default=1.2, min=0.0, max=20.0, step=0.05, advanced=True),
                io.Float.Input("omega_scale", default=0.75, min=0.0, max=2.0, step=0.05, advanced=True),
